...
[![API docs](https://img.shields.io/badge/API_docs_-view-85EA2D.svg?logo=swagger)](https://digital-canteen-api-dev.prison.service.justice.gov.uk/swagger-ui/index.html)
...
## Renaming from HMPPS Digital Canteen Api - github Actions
...
```bash
docker compose pull && docker compose up --scale hmpps-digital-canteen-api=0
```
