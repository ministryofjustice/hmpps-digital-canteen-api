...
class OpenApiDocsTest : IntegrationTestBase() {
  ...
  @ParameterizedTest
  @Disabled("TODO Enable this test once you have added security schema to OpenApiConfiguration." +
    "OpenAPi().components(). Add the security scheme / roles to @CsvSource")
